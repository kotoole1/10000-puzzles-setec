...
print(elements('access'))
print(elements('dvorak'))
print(elements('elephant'))
print(elements('ghosty'))
print(elements('new'))
print(elements('news'))
print(elements('qwerty'))
print(elements('racecar'))
print(elements('see'))
print(elements('sew'))
print(elements('typewriter'))
print(elements('weed'))